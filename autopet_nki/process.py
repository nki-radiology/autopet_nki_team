...
class Autopet_baseline():  # SegmentationAlgorithm is not inherited in this class anymore
    ...
    def __init__(self):
        ...
        self.nii_path = '/opt/algorithm/nnFormer_raw/nnFormer_raw_data/Task501_AutopetFull/imagesTs'
        self.result_path = '/opt/algorithm/nnFormer_raw/nnFormer_raw_data/Task501_AutopetFull/result'
    ...
    def load_inputs(self):
        ...
        #Our ct is _0000 and pet is _0001
    ...
    def predict(self):
        ...
        """
        #cproc = subprocess.run(f'nnFormer_predict -i {self.nii_path} -o {self.result_path} -t 501 -m 3d_fullres', shell=True, check=True)
        #os.system(f'nnFormer_predict -i {self.nii_path} -o {self.result_path} -t 501 -m 3d_fullres')
        print("nnFormer segmentation starting!")
        ...
        #Change trainer_class_name in the right folder !!!!!
        ...
        print("nnFormer segmentation done!")
        if not os.path.exists(os.path.join(self.result_path, self.nii_seg_file)):
            print('waiting for nnFormer segmentation to be created')
