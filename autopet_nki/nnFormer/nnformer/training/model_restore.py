...
def restore_model(pkl_file, checkpoint=None, train=False, fp16=None):
    ...
    assert issubclass(tr, nnFormerTrainer), "The network trainer was found but is not a subclass of nnUNetTrainer. " \
                                          "Please make it so!"
